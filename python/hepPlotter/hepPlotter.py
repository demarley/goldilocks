...
class HepPlotter(object):
    ...
    def setYAxis(self,y_axis):
        ...
        if self.logplot:
            ...
            if len(set(axis_yticks.astype(int)))==len(axis_yticks):
                ...
                y_axis.set_yticklabels(["{0:.1f}".format(i) for i in axis_yticks[0:-1]],fontProperties,fontsize=self.label_size)
    ...
    def setXAxis(self,x_axis):
        ...
        if len(set(x_axis_xticks.astype(int)))==len(x_axis_xticks):
            ...
            # axis labels have decimals
            x_axis.set_xticklabels(["{0:.1f}".format(i) for i in x_axis_xticks],fontProperties,fontsize=self.label_size)
